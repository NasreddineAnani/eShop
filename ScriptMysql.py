...
query5 = 'CREATE TABLE cart (userId INT(11) NOT NULL, idProduct INT(11), quantityInCart INT(11), PRIMARY KEY (userId, idProduct), FOREIGN KEY (userId) REFERENCES users(userId) ON UPDATE CASCADE);'
