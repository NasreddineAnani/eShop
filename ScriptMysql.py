...
query5 = 'CREATE TABLE cart (userId INT(11) NOT NULL, idProduct INT UNSIGNED, quantityInCart INT(11), PRIMARY KEY (userId, idProduct), FOREIGN KEY (userId) REFERENCES users(userId) ON UPDATE CASCADE, FOREIGN KEY (idProduct) REFERENCES products(idProduct) ON UPDATE CASCADE);'
